...
public class PlayerMover : MonoBehaviourPun
{
    ...
    void Update()
    {
        ...
        if ((vertical != 0 || horizontal != 0) && !animator.GetBool("walking"))
            animator.SetBool("walking", true);
        else if (vertical == 0 && horizontal == 0 && animator.GetBool("walking"))
        ...
        if (horizontal != 0)
        {
            var rotation = Quaternion.Euler(0, horizontal * 90, 0);
